...
viewsRouter.use("/product", serveStatic("/product-detail"));
...
viewsRouter.use("/adminuserlist", serveStatic("admin-userlist"));
viewsRouter.use("/myPage/orderList", serveStatic("user-order-list"));
